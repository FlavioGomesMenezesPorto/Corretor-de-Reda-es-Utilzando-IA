...
def import_data(args) -> None:
    ...
    print(f"{total} redações importadas para {args.database}")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser_db = subparsers.add_parser("init-db", help="Criar tabelas no SQLite")
    parser_db.add_argument("--database", default="IA.db")
    parser_db.add_argument("--schema", default="schema_ava.sql")
    parser_db.set_defaults(func=init_db)

    parser_import = subparsers.add_parser("import-data", help="Importar CSV para o SQLite")
    parser_import.add_argument("--data", required=True)
    parser_import.add_argument("--database", default="IA.db")
